...
static SHOW_VAR innodb_status_variables[]= {
  ...
  {"buffer_pool_pages_optimistic_fail_latch_busy_purge",
   &buf_pool.n_optimistic_fail_latch_busy_purge, SHOW_SIZE_T},
  {"buffer_pool_pages_optimistic_fail_latch_busy_foreground",
   &buf_pool.n_optimistic_fail_latch_busy_foreground, SHOW_SIZE_T},
  {"buffer_pool_pages_optimistic_fail_modify_clock",
   &buf_pool.n_optimistic_fail_modify_clock, SHOW_SIZE_T},
  {"buffer_pool_pages_optimistic_fail_freed",
   &buf_pool.n_optimistic_fail_freed, SHOW_SIZE_T},
  {"buffer_pool_pages_optimistic_fail_reused",
   &buf_pool.n_optimistic_fail_reused, SHOW_SIZE_T},
  {"buffer_pool_pages_optimistic_fail_sibling",
   &buf_pool.n_optimistic_fail_sibling, SHOW_SIZE_T},
  {"buffer_pool_merge_attempts_purge",
   &buf_pool.n_merge_attempts_purge, SHOW_SIZE_T},
  {"buffer_pool_merge_attempts_foreground",
   &buf_pool.n_merge_attempts_foreground, SHOW_SIZE_T},
  {"buffer_pool_merge_successful_purge",
   &buf_pool.n_merge_successful_purge, SHOW_SIZE_T},
  {"buffer_pool_merge_successful_foreground",
   &buf_pool.n_merge_successful_foreground, SHOW_SIZE_T},
  {"buffer_pool_pages_split_purge",
   &buf_pool.n_pages_split_purge, SHOW_SIZE_T},
  {"buffer_pool_pages_split_foreground",
   &buf_pool.n_pages_split_foreground, SHOW_SIZE_T},
  {"buffer_pool_merge_attempts_x_latch",
   &buf_pool.n_merge_attempts_x_latch, SHOW_SIZE_T},
  {"buffer_pool_merge_attempts_sx_latch",
   &buf_pool.n_merge_attempts_sx_latch, SHOW_SIZE_T},
  {"buffer_pool_purge_sec_leaf_removed",
   &buf_pool.n_purge_sec_leaf_removed, SHOW_SIZE_T},
  {"buffer_pool_purge_sec_tree_fallback",
   &buf_pool.n_purge_sec_tree_fallback, SHOW_SIZE_T},
